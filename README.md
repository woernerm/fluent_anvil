...
Personally, I also find fluent easier to learn and use than gettext. In the end, a translation for a given locale is just a text file with string definitions like:
```
close-button = Close
```
